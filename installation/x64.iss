...
[Setup]
OutputBaseFilename=riva-dosbox-logger-win-x64-{#MyAppVersion}-setup
...
Source: "..\vs\x64\Release\dosbox-roa3.exe"; DestName: "dosbox-roa3.exe"; DestDir: "{app}\dosbox-roa3"; Flags: ignoreversion
...
Source: "..\vcpkg_installed\x64-windows\x64-windows\bin\zlib1.dll";  DestDir: "{app}\dosbox-roa3"; Flags: ignoreversion
